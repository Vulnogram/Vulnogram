...
app.use(function (req, res, next) {
    ...
    res.setHeader('Content-Security-Policy', "default-src 'self' data: 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline'; connect-src 'self' https://whimsy.khulnasoft.com; frame-ancestors 'self';");
...
// KSF
ksf.ksfroutes(ensureAuthenticated, app);
// END KSF
// set up routes
